...
abstract class $PokemonListResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Pokemon> results, int count, String? next, String? previous});
}
...
class _$PokemonListResponseImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PokemonListResponse(results: $results, count: $count, next: $next, previous: $previous)';
  }
...
abstract class _PokemonListResponse implements PokemonListResponse {
  factory _PokemonListResponse(
      ...
      final String? next,
      final String? previous}) = _$PokemonListResponseImpl;
